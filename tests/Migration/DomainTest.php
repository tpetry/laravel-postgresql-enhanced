...
class DomainTest extends TestCase
{
    ...
    public function testUseDomain(): void
    {
        ...
        $this->assertEquals(['create table "historic_prices" ("id" bigserial not null primary key, "price" gasprice not null, "date" timestamp(0) with time zone not null)'], array_column($queries, 'query'));
    }
}
