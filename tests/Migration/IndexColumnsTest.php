...
class IndexColumnsTest extends TestCase
{
    ...
    {
        Schema::create('test_308394', static function (Blueprint $table): void {
            $table->string('col_797129');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_308394', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_831289', static function (Blueprint $table): void {
            $table->string('col_475002');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_831289', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_217958', static function (Blueprint $table): void {
            $table->string('col_613233');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_217958', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_185445', static function (Blueprint $table): void {
            $table->string('col_803421');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_185445', static function (Blueprint $table): void {
    ...
    public function testRawIndexEscapedColumn(): void
    {
        ...
        Schema::create('test_828707', static function (Blueprint $table): void {
            $table->string('col_594662');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_828707', static function (Blueprint $table): void {
    ...
    public function testRawIndexFunctionalExpression(): void
    {
        ...
        Schema::create('test_470192', static function (Blueprint $table): void {
            $table->jsonb('col_996346');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_470192', static function (Blueprint $table): void {
    ...
    public function testRawIndexParametrized(): void
    {
        ...
        Schema::create('test_601845', static function (Blueprint $table): void {
            $table->string('col_112904');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_601845', static function (Blueprint $table): void {
    ...
    public function testRawIndexUnescapedColumn(): void
    {
        ...
        Schema::create('test_124336', static function (Blueprint $table): void {
            $table->string('col_347405');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_124336', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_703492', static function (Blueprint $table): void {
            $table->integerRange('col_935342');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_703492', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_135019', static function (Blueprint $table): void {
            $table->ipAddress('col_206720');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_135019', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_259840', static function (Blueprint $table): void {
            $table->integerRange('col_454276');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_259840', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_875006', static function (Blueprint $table): void {
            $table->integerRange('col_568824');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_875006', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_976351', static function (Blueprint $table): void {
            $table->string('col_561202');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_976351', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_331602', static function (Blueprint $table): void {
            $table->string('col_929728');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_331602', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_477236', static function (Blueprint $table): void {
            $table->string('col_177070');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_477236', static function (Blueprint $table): void {
    ...
    {
        Schema::create('test_537068', static function (Blueprint $table): void {
            $table->string('col_496793');
        });
        $queries = $this->withQueryLog(static function (): void {
            Schema::table('test_537068', static function (Blueprint $table): void {
