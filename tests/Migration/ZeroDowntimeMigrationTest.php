...
class ZeroDowntimeMigrationTest extends TestCase
{
    public function testLongRunningApplicationLogicIsCancelled(): void
    {
        ...
        $this->runMigration(static fn () => usleep(500_000), new class extends Migration {
    ...
    public function testMigrationNeedsToRunInTransaction(): void
    {
        ...
        $this->runMigration(static fn () => usleep(1000), new class extends Migration {
            use ZeroDowntimeMigration;
            public $timeout = 0.0;
    ...
    {
        $this->expectNotToPerformAssertions();
        $this->runMigration(static fn () => usleep(25_000), new class extends Migration {
            use ZeroDowntimeMigration;
            public $timeout = 0.04;
        });
        $this->runMigration(static fn () => usleep(25_000), new class extends Migration {
