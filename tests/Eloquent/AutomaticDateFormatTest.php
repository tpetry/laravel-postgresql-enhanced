...
class AutomaticDateFormatTest extends TestCase
{
    ...
    public function testAutomaticDateFormat(): void
    {
        $time = CarbonImmutable::createFromTimeString('2023-05-05 16:49:51+02:00');
        ...
        $this->assertEquals($time->shiftTimezone('UTC'), $row->getAttribute('timestamp_p0'));
        $this->assertEquals($time->shiftTimezone('UTC'), $row->getAttribute('timestamp_p6'));
        $this->assertEquals($time, $row->getAttribute('timestamptz_p0'));
